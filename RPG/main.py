                ...
                if victory is not None:
                    if current_character is False:
                        ...
                        if fight_with in backpack:
                            ...
                            elif ready_to_fight is None:
                                print("")

                            elif ready_to_fight is False:
                                dead = True

                        elif fight_with not in backpack:
